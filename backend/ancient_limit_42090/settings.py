"""
Django settings for ancient_limit_42090 project.
...
ROOT_URLCONF = 'ancient_limit_42090.urls'
...
WSGI_APPLICATION = 'ancient_limit_42090.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ancient_limit_42090 API",
    "DESCRIPTION": "API documentation for ancient_limit_42090 App",
    "VERSION": "v1",
}
